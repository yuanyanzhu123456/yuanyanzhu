...
VALUES
	(1,'2018-01-01 00:00:00','默认','运营超级管理员','Administrator','运营超级管理员',0,1,0,1),
	(2,'2018-01-01 00:00:00','默认','超级管理员','Root','超级管理员',2,1,1,0),
	(3,'2018-01-01 00:00:00','默认','管理员','Admin','管理员',2,1,1,0),
	(4,'2018-01-01 00:00:00','默认','普通用户','User','普通用户',2,1,1,0),
	(5,'2018-01-01 00:00:00','默认','超级管理员','Root','超级管理员',5,1,0,1),
	(6,'2018-01-01 00:00:00','默认','管理员','Admin','管理员',6,1,0,1),
	(7,'2018-01-01 00:00:00','默认','普通用户','User','普通用户',5,1,0,1);

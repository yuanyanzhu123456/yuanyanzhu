package com.geo.rcs.modules.emp.entity;
...
public class Staff implements Serializable{
	...
	public String toString() {
		return "AbTest [id=" + id + ", username=" + username + ", password=" + password + ", name=" + name + ", contact="
				+ contact + ", email=" + email + ", mobilephone=" + mobilephone + ", status=" + status + ", createTime="
				+ createTime + ", creater=" + creater + ", roleId=" + roleId + ", roleIdList=" + roleIdList
				+ ", loginIp=" + loginIp + ", loginDate=" + loginDate + ", pageSize=" + pageSize + ", pageNo=" + pageNo
				+ ", userType=" + userType + ", uniqueCode=" + uniqueCode + ", company=" + company + ", roleName="
				+ roleName + ", passwordTwo=" + passwordTwo + ", salt=" + salt + ", roleList=" + roleList

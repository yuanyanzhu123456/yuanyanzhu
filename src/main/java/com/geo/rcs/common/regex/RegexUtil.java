package com.geo.rcs.common.regex;

/**
 * @Project : rcs
 * @Package Name : com.geo.rcs.common.regex
 * @Description : TODD
 * @Author guoyujie
 * @email guoyujie@geotmt.com
 * @Creation Date : 2018年08月10日 下午6:59
 */
...
public class RegexUtil {
    ...
    public static boolean checkIdCard(String idCard) {
        String regex = "[1-9]\\d{15,18}[a-zA-Z0-9]{1}";
    ...
    public static void main(String[] args) {
        String birthday = "16606328903";
        boolean b = checkMobile(birthday);
        System.out.printf(""+b);
    }
